package com.cracker.money.common.response;
...
public enum BaseResponseStatus {
     ...
     * 200 : 요청 성공
     */
    SUCCESS(true, HttpStatus.OK.value(), "Successfully executed."),
    ...
    USERS_EMPTY_USER_NAME(false, HttpStatus.BAD_REQUEST.value(), "Please input user name"),
    USERS_EMPTY_PASSWORD(false, HttpStatus.BAD_REQUEST.value(), "Please input password."),
    ...
    DUPLICATED_EMAIL(false, HttpStatus.BAD_REQUEST.value(), "This email is already in use."),
